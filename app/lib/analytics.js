...
Balanced.Analytics = Balanced.Analytics || (function () {
    var analytics = {};
...
b._i.push([a,e,d])};b.__SV=1.2}})(document,window.mixpanel||[]);
    ...
    // the rapid clicking in phantom causes an error,
    var mixpanel_trackPageview = _.debounce(function () {
	try {
	    return mixpanel.track_pageview.apply(this, arguments);
	} catch(e) { }
    }, 500);
    analytics.trackPage = _.debounce(function(page) {
	_gaq.push(['_trackPageview', page+location.hash]);
	mixpanel_trackPageview(page+location.hash);
    ...
    // Bindings to events
    ////////////////////////////////////
    balancedSetupFunctions.push(function() {
    ...
    var mixpanel_trackClick = _.debounce(function () {
	// this fixes issues with phantomjs where the clicks come in too rapidly
	try {
